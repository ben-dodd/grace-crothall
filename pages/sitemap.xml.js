...
export const getServerSideProps = ({ res }) => {
  ...
  <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
    ...
    <url>
      ...
      <image:image>
        <image:loc>{encodeURI(https://www.gracecrothall.com/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fgrace-crothall%2Fimages%2Ftitle-images%2F600px%2Falcala.jpg&w=1200&q=75)}</image:loc>
        <image:title>Grace Crothall - Alcala</image:title>
      </image:image>
      <image:image>
        <image:loc>{encodeURI(https://www.gracecrothall.com/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fgrace-crothall%2Fimages%2Ftitle-images%2F600px%2Fshelter-house.jpg&w=1200&q=75)}</image:loc>
    ...
    <url>
      ...
      <image:image>
        <image:loc>{encodeURI(https://www.gracecrothall.com/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fgrace-crothall%2Fimages%2Ftitle-images%2F600px%2Falcala-install-view.jpg&w=1200&q=75)}</image:loc>
        <image:title>Grace Crothall - Alcala install view</image:title>
      </image:image>
      <image:image>
        <image:loc>{encodeURI(https://www.gracecrothall.com/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fgrace-crothall%2Fimages%2Ftitle-images%2F600px%2Falcala-bealey-sloughing.jpg&w=828&q=75)}</image:loc>
